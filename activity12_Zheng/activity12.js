...
const viewPassword = document.querySelector('#viewPassword');
  viewPassword.addEventListener('click', function(){
    const secret = myPassword.getAttribute('type')==='password' ? 'text':'password'; myPassword.setAttribute('type', secret)
  })
...
function slideshow(n){
  ...
  // when currentSlide reaches to the first slide, the prev button will set to the last slide
