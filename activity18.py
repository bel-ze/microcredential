...
print("\n\n------ WHILE LOOP ------------- ")
print("Example 15) ask user to enter two numbers between 0 and 10 with checkpoint. Use a while loop to increment each number by 2 until the sum of them each up to 30 ") 
...
print("Example 14) checkpoint: create a while looop that checks if an entered number is between 0 and 10 ")
number = int(input("Enter a number between 0 and 10: "))
while number<0 or number>10:
    number = int(input("Try again! Enter a number between 0 and 10: "))
print("Entered number = ", number)

print("Example 13) user enters two number between 0 and 10. Use while loop to increment each number by 2 until one of them reach up to 20")
...
for n in range (7):
    ...
    print("DONE!")
print("\n\n------ FOR LOOP ------------- ")
print("Example 10) use for loop to print num for 10 to -5 and skip numbers that are multiple of 4")
...
if age ==5 and gender =="M" or gender =="m":
    ...
    print("Amy other ages rather than 5")
...
if age == 5:
    ...
    print("Age = 7. Height should be around 102 cm and weight 18.0 lbs")
else:
